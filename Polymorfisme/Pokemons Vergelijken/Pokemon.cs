...
namespace Pokemons_Vergelijken
{
    class Pokemon
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (Name == poke.Name && Level == poke.Level && HP_Base == poke.HP_Base && Attack_Base == poke.Attack_Base && Defense_Base == poke.Defense_Base && SpecialAttack_Base == poke.SpecialAttack_Base && SpecialDefense_Base == poke.SpecialDefense_Base && Speed_Base == poke.Speed_Base)
            {
                return true;
            }
            else
